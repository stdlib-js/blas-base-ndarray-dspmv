...
/**
* BLAS level 2 routine to perform the matrix-vector operation `y = alpha*A*x + beta*y` for a symmetric matrix `A` supplied in packed form.
*
* @module @stdlib/blas-base-ndarray-dspmv
*
* @example
